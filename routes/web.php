...
//Home Page
Route::get('/todays-deals', 'HomeController@todaydeals')->name('today.deals');
...
// shurjopay start
Route::get('/shurjopay/success','ShurhoPayController@success');
Route::get('/shurjopay/cancel', 'ShurhoPayController@cancel');
// shurjopay start
...
Route::get('/shippingpolicy', 'HomeController@shippingpolicy')->name('shippingpolicy');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/order/notes', 'OrderController@get_notes')->name('order.notes');
