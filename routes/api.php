...
Route::prefix('v2')->group(function () {
    ...
    Route::get('purchase-history-details/{id}', 'Api\V2\PurchaseHistoryController@details')->name('purchaseHistory.details');
    ...
    // shurjo pay start
    Route::get('shurjopay/begin', 'Api\V2\ShurjoPayController@begin');
    Route::post('shurjopay/success', 'Api\V2\ShurjoPayController@payment_success');
    Route::post('shurjopay/fail', 'Api\V2\ShurjoPayController@payment_fail');
    Route::post('shurjopay/cancel', 'Api\V2\ShurjoPayController@payment_cancel');
    // shurjo pay end
