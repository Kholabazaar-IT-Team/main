            ...
            <table class="table aiz-table mb-0">
                ...
                @php $status = $affiliate_withdraw_request->status ; @endphp
                    <tr>
                        ...
                        <td>{{ $affiliate_withdraw_request->user?$affiliate_withdraw_request->user->name:'Not Found'}}</td>
                        <td>{{ $affiliate_withdraw_request->user?$affiliate_withdraw_request->user->email:'Not Found'}}</td>
