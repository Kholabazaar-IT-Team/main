                    ...
                    <tr>
						...
						<td class="text-right">
                            <div class="d-flex align-items-center justify-content-end">
                                 ...
                                 <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete mx-2" data-href="{{route('flash_deals.destroy', $flash_deal->id)}}" title="{{ translate('Delete') }}">
                                     <i class="las la-trash"></i>
                                 </a>
                                 <form action="{{ route('fleash_deals.notify',$flash_deal->id) }}" method="GET">
                                     <button class="btn btn-soft-success btn-icon btn-circle btn-sm "  title="{{ translate('Notify Users') }}">
