              ...
              <form class="p-4" action="{{ route('flash_deals.update', $flash_deal->id) }}" method="POST">
                ...
                @csrf
                  ...
                  <div class="form-group row">
                        <label class="col-sm-3 control-label" for="name">{{translate('Show category wise')}}</label>
                        <div class="col-sm-9">
                        <select id="scw" name="show_cat_wise" class="form-control demo-select2">
                                <option value="1" @if ($flash_deal->is_cat_wise == 1) selected @endif>ON</option>
                                <option value="0" @if ($flash_deal->is_cat_wise == 0) selected @endif>OFF</option>
                            </select>
                        </div>
                    </div>
