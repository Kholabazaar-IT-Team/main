...
<div class="card">
    ...
    <div class="card-body">
        <div class="row gutters-5 mb-5">
            ...
            <div class="col-md-3 ml-auto">
                ...
                @if($delivery_status != 'delivered' && $delivery_status != 'cancelled')
                    <select class="form-control aiz-selectpicker"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
                        ...
                        <option value="hold" @if ($delivery_status == 'hold') selected @endif>Hold</option>
            ...
            <div class="col-md-3 ml-auto" id="note_col">
            <label for="note" class="text-danger">Note</label>
                    <input type="text" id="note" class="form-control"  placeholder="Type Note & Hit Enter">
            </div>
        </div>
                ...
                <table class="table table-bordered aiz-table invoice-summary">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if ($orderDetail->product != null)
                            @php
                                $stock=App\ProductStock::where('product_id',$orderDetail->product->id)->where('variant',$orderDetail->variation)->first();
                            @endphp
                                @if($stock)
                                    <td>{{ $stock->sku }}</td>
                                @else
