...
<div class="">
	<div class="">
     ...
     {{-- mobile app banner --}}
        <div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Mobile App Banner') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="form-group">
						<label>{{ translate('Banner & Flashdeals') }}</label>
						<div class="home-banner1-target">
                            @php
                                $flash_deals=\App\FlashDeal::all();
                            @endphp
									<div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                    <input type="hidden" name="types[]" value="mobile_banner_image1">
					                                <input type="hidden" name="mobile_banner_image1" class="selected-files" value="{{get_setting('mobile_banner_image1')}}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
                                                <input type="hidden" name="types[]" value="mobile_banner_link1">
                                                <select class="form-control" name="mobile_banner_link1" id="">
                                                    <option value="">--Select--</option>
                                                    @foreach ($flash_deals as  $deal)
                                                        <option value="{{ $deal->id }}" @if(get_setting('mobile_banner_link1')==$deal->id) selected @endif>{{ $deal->title }}</option>
                                                    @endforeach
                                                </select>
											</div>
										</div>
                                    ...
                                    <div class="row gutters-5">
										<div class="col-md-5">
											<div class="form-group">
												<div class="input-group" data-toggle="aizuploader" data-type="image">
					                                ...
					                                <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                                                    <input type="hidden" name="types[]" value="mobile_banner_image2">

					                                <input type="hidden" name="mobile_banner_image2" class="selected-files" value="{{get_setting('mobile_banner_image2')}}">
					                            </div>
					                            <div class="file-preview box sm">
					                            </div>
				                            </div>
										...
										<div class="col-md">
											<div class="form-group">
                                                <input type="hidden" name="types[]" value="mobile_banner_link2">

                                                <select class="form-control" name="mobile_banner_link2" id="">
                                                    <option value="">--Select--</option>
                                                    @foreach ($flash_deals as  $deal)
                                                        <option value="{{ $deal->id }}" @if(get_setting('mobile_banner_link2')==$deal->id) selected @endif>{{ $deal->title }}</option>
                                                    @endforeach
                                                </select>
											</div>
										</div>
