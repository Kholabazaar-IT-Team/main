    			...
    			<div class="card-body">
    				<form action="{{ route('business_settings.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="form-group row">
    	                    <label class="col-md-3 col-from-label">Per-page Products Amount</label>
                            <div class="col-md-8">
                                <input type="hidden" name="types[]" value="per_page_pagination">
        	                    <input type="number" name="per_page_pagination" class="form-control"value="{{  get_setting('per_page_pagination') }}">
