...
<div class="card">
    ...
    <div class="card-header d-block d-md-flex">
        ...
        <h5 class="mb-0 h6">{{ translate('Categories wise product report') }}</h5>
        ...
        <table class="table aiz-table mb-0">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th data-breakpoints="lg">{{ translate('Total Product') }}</th>
...
$category_ids = App\Utility\CategoryUtility::children_ids($category->id);
            ...
            $products = $products->whereIn('category_id', $category_ids)->count();
