    ...
    <form class="" id="sort_products" action="" method="GET">
        ...
        <div class="row">
            ...
            <div class="col">
                 ...
                 <h5 class="mb-md-0 h6 text-center p-3">{{ translate('All Product')}} ({{ App\Product::count() }})</h5>
        ...
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-2 ml-auto">
                ...
                <select class="form-control form-control-sm aiz-selectpicker mb-2 mb-md-0" id="product_stat" name="product_stat" onchange="sort_products()">

                    <option value="">{{ translate('All Products') }}</option>

                            <option value="todays_deal"  @if($product_stat=="todays_deal") selected @endif>Todays Deals</option>

                            <option value="featured"  @if($product_stat=="featured") selected @endif>Featured</option>

                            <option value="published" @if($product_stat=="published") selected @endif>Published</option>

                            <option value="un_published" @if($product_stat=="un_published") selected @endif>Unpublished</option>
            ...
            <div class="col-md-2">
                ...
                <div class="form-group mb-0">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="text" class="form-control form-control-sm" id="search" name="search"@isset($sort_search) value="{{ $sort_search }}" @endisset onchange="sort_products()" placeholder="Type Name & Enter">
            ...
            <div class="col-md-2">
                ...
                <div class="form-group mb-0">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="text" class="form-control form-control-sm" id="sku" name="sku"@isset($sku) value="{{ $sku }}" @endisset onchange="sort_products()" placeholder="Type SKU & Enter">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @php 
                            $product_stock = App\ProductStock::where('product_id',$product->id)->first();
                           @endphp
                           @if($product_stock)
                            <strong>SKU: </strong> {{ $product_stock->sku }}
                           @endif
                            ...
                            @php
                                ...
                                if($product->variant_product) {
                                    ...
                                    foreach ($product->stocks as $key => $stock) {
                                        ...
                                        if($sku && $stock->sku == $sku){

                                            echo '<div class="p-1" style="background-color: rgb(0, 0, 0);color:aliceblue;">'.$stock->variant.' - '.$stock->qty.'<br>'.'<span class="text text-success"> SKU:('.$stock->sku.') </span><br></div>';

                                        }

                                        else{

                                            echo '<div class="p-1">'.$stock->variant.' - '.$stock->qty.'<br>'.'<span class="text text-primary"> SKU:('.$stock->sku.') </span><br></div>';
