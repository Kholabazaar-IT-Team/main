            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="SHURJOPAY_USERNAME">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Sslcz Store Id')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="SHURJOPAY_USERNAME" value="{{  env('SHURJOPAY_USERNAME') }}" placeholder="{{translate('Shurjopay Username')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="SHURJOPAY_PASSWD">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Sslcz store password')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="SHURJOPAY_PASSWD" value="{{  env('SHURJOPAY_PASSWD') }}" placeholder="{{translate('Shurjopay  password')}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('shurjopay Sandbox Mode')}}</label>
                            </div>
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="shurjopay_sandbox" type="checkbox" @if (get_setting('shurjopay_sandbox') == 1)
                                        checked
                                    @endif>
                                    <span class="slider round"></span>
                                </label>
