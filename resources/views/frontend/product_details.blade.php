                        ...
                        @endif
                                        ...
                                        @if($detailedProduct->is_wholesale==1)
                                         ...
                                         <div class="product-quantity d-flex align-items-center">
                                                 <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                                                     ...
                                                     <input type="text" name="quantity" class="col  text-center flex-grow-1 fs-16 input-number-wholesale mx-2" placeholder="0" value="{{ $detailedProduct->min_variant_cost[0]->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="{{ $qty }}" data-max="{{ $detailedProduct->max_qty }}">
                                         ...
                                         @else
                                             <div class="product-quantity d-flex align-items-center">
                                                 <div class="row no-gutters align-items-center aiz-plus-minus mr-3" style="width: 130px;">
                                                     ...
                                                     <input type="text" name="quantity" class="col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="{{ $detailedProduct->min_qty }}" min="{{ $detailedProduct->min_qty }}" max="{{ $detailedProduct->max_qty }}" data-max="{{ $detailedProduct->max_qty }}">
                                                     <button class="btn  col-auto btn-icon btn-sm btn-circle btn-light" type="button" data-type="plus" data-field="quantity">
                                                         <i class="las la-plus"></i>
                                                     </button>
                                                 </div>
                           ...
                           @endif
                            ...
                            @if ($refund_request_addon != null && $refund_request_addon->activated == 1 && $detailedProduct->refundable)
                                <div class="row no-gutters mt-4">
                                    <div class="col-sm-4">
                                        <div class="opacity-50 my-2">{{ translate('Refund')}}:<a href="{{ route('returnpolicy') }}" class="ml-2" target="_blank">{{ translate('View Policy') }}</a></div>
