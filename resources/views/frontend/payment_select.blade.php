            ...
            <div class="col-lg-8">
                <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST" id="checkout-form">
                            ...
                            <div class="row">
                                <div class="col-xxl-8 col-xl-10 mx-auto">
                                    <div class="row gutters-10">
                                        ...
                                        @endif
                                        @if(get_setting('shurjopay_payment') == 1)
                                            <div class="col-6 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    <input value="shurjopay" class="online_payment" type="radio" name="payment_option" checked>
                                                    <span class="d-block p-3 aiz-megabox-elem">
                                                        <img src="{{ static_asset('assets/img/cards/surjopay.jpg')}}" class="img-fluid mb-2 " style="height: 74px;">
                                                        <span class="d-block text-center">
                    ...
                    <div class="pt-3">
                     ...
                     <div class="pt-3">
                        <label class="aiz-checkbox">
                            <input type="checkbox" required id="agree_checkbox2">
                            <span class="aiz-square-check"></span>
                            <span>{{ translate('I agree to the')}}</span>
                        </label>
                        <!-- <a href="{{ route('shippingpolicy') }}">Shipping Charge's terms and conditions</a> -->
                        <a href="#">Delivery charges will be added after conversation.</a>
