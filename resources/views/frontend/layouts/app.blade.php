...
<body class=" homepage " style="background-color: #f9f9f9;">
    <!-- aiz-main-wrapper -->
    <div class="aiz-main-wrapper d-flex flex-column" style="width:100vw;">
...
<script>
    ...
    <script>
        ...
        $(document).ready(function() {
        // request to fetch category menue
            ...
            if(typeof id != 'undefined'){
                ...
                $.post('{{ route('cart.addToCart') }}', { _token : AIZ.data.csrf, id : id, quantity: '1'}, function(data){
                    if(data.status == 1){
                        ...
                        AIZ.plugins.notify('danger', 'Max Purchase Quantity Reached');
                    }else{
