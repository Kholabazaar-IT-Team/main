        ...
        <a href="{{ route('categories.all') }}" class="text-reset text-light">
           <div class="d-flex align-items-center">
                <button class="aiz-mobile-toggler mx-2">
                    <span></span>
                </button> <span class="fw-600 fs-13 mr-3 text-uppercase">{{ translate('All categories') }}</span>
           </div>
            {{-- <span class="d-none d-lg-inline-block">{{ translate('See All') }} ></span> --}}
        </a>
    </div>
   {{-- <div class="px-1  z-1000"> --}}
        <ul class="list-unstyled shadow-md categories no-scrollbar py-2 mb-0 text-left scroll-menue px-1" >
...
{{-- <div class="aiz-category-menu bg-white @if(Route::currentRouteName() == 'home') shadow-sm" @else shadow-lg" id="category-sidebar" @endif>
    <div class="p-3 bg-alter d-none d-lg-block all-category position-relative text-left">
