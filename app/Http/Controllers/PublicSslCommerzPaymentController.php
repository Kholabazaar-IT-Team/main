...
//                    $post_data['cus_email'] = $request->session()->get('shipping_info')['email'];
                ...
                if ($user) {
                    ...
                    $address = json_decode($carts[0]->shipping_address);
    
                    $post_data['cus_name'] = $address->name;
                    $post_data['cus_add1'] = $address->address;
                    $post_data['cus_city'] = $address->city;
                    $post_data['cus_postcode'] = $address->postal_code;
                    $post_data['cus_country'] = $address->country;
                    $post_data['cus_phone'] = $address->phone;
                    $post_data['cus_email'] = $address->email ? $address->email : 'guest@gmail.com';
                }
