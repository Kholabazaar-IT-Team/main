    ...
    public function index(Request $request)
    {
        ...
        if ($request->has('search')){
            ...
            $user_ids = User::where('user_type', 'customer')->where(function($user) use ($sort_search){
                 $user->where('name', 'like', '%'.$sort_search.'%')->orWhere('phone', 'like', '%'.$sort_search.'%')->orWhere('email', 'like', '%'.$sort_search.'%');
            })->pluck('id')->toArray();
        ...
        if($request->button == 'export'){
            return Excel::download(new CustomersExport($customers->with('user')->get()), 'customers_data.xlsx');
