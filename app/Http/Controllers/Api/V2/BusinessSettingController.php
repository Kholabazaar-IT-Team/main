...
class BusinessSettingController extends Controller
{
    ...
    public function home_banner_2(){
     ...
     public function deal_banners(){
        $data=[];
        $temp1['image']=api_asset(get_setting('mobile_banner_image1'));
        $temp1['link']=route('flash.products',get_setting('mobile_banner_link1'));
        $temp2['image']=api_asset(get_setting('mobile_banner_image2'));
        $temp2['link']=route('flash.products',get_setting('mobile_banner_link2'));
