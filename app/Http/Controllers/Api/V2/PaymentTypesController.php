...
class PaymentTypesController
{
    ...
    public function getList(Request $request)
    {
        ...
        if ( get_setting('shurjopay_payment') == 1) {
            $payment_type = array();
            $payment_type['payment_type'] = 'shurjopay_payment';
            $payment_type['payment_type_key'] = 'shurjopay';
            $payment_type['image'] = static_asset('assets/img/cards/surjopay.jpg');
            $payment_type['name'] = "Shurjopay";
            $payment_type['title'] = "Checkout with shurjopay";
            if($mode == 'wallet') {
                $payment_type['title'] = "Recharge with shurjopay";
            }
